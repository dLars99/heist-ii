...
namespace HeistII
{
    class Program
    {
        ...
        {
            List<IRobber> rolodex = DefaultCrooks();
            RecruitGoons(rolodex);

            Bank targetBank = CreateBank();
            BankReport(targetBank);

            List<IRobber> crew = AssembleCrew(rolodex);

            PerformHeist(targetBank, crew);
        ...
        static List<IRobber> DefaultCrooks()
        {
        ...
        static void BankReport(Bank targetBank)
        {
        ...
        static List<IRobber> AssembleCrew(List<IRobber> rolodex)
        {
        ...
        static void PerformHeist(Bank targetBank, List<IRobber> crew)
        {
            Console.Clear();
